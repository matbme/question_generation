# coding=utf-8
# Copyright 2020 The TensorFlow Datasets Authors and the HuggingFace
# NLP Authors.
#
...
class SquadMultitask(nlp.GeneratorBasedBuilder):
    ...
    def _get_correct_alignement(self, context, answer):
        """ Some original examples in SQuAD have indices wrong by
        1 or 2 characters. We test and fix this here. """
    ...
    def process_qa_text(self, context, question, answer):
        ...
        return {"source_text": ans_gen_input,
    ...
    def process_ans_ext(self, paragraph):
        ...
        for i, ans in enumerate(sent_answers):
            ...
            examples.append({"source_text": input_text,
                             "target_text": target_text,
                             "task": "ans_ext"})
            ...
            for article in squad["data"]:
                ...
                for paragraph in article["paragraphs"]:
                    ...
                    for qa in paragraph["qas"]:
                        ...
                        for task in tasks:
                            if task == 'qa':
                                yield count, self.process_qa_text(context,
                                                                  question,
                                                                  answers[0])
                                count += 1
                            ...
                            if task == 'qg':
                                if qa["answers"][0]["answer_start"] != 0:
                                    yield count, self.process_qg_text(context,
                                                                      question,
                                                                      qa["answers"][0])
                                    count += 1
